"""Calculadora com while, de forma mais completa com"""
...
while True:
    ...
    if len(operador) > 1:# Aqui so irei confirmar se o usuario usou apenas um operador ou mais. caso mais que 1 aparece a mensageme inicia o laço tambem.
    ...
    # Obs: O mesmo codigo em cima que está em 3 linhas (para uma melhor compreensão) pode ser feito em uma como no exemplo abaixo. 
